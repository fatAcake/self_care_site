...
namespace Self_care.Controllers
{
    ...
    public class HabitController : ControllerBase
    {
        ...
        // Получить все доступные привычки (общие + созданные текущим пользователем)
        [HttpGet("all")]
        public async Task<IActionResult> GetAllHabits()
        {
            try
            {
                ...
                var habits = await _db.Habits
                    .Where(h => !h.Deleted && (h.UserId == null || h.UserId == userId))
        ...
        // Получить привычки пользователя на определенную дату
        [HttpGet("user-habits")]
        ...
        // Получить прогресс на определенную дату
        [HttpGet("progress")]
        ...
        // Создать новую привычку (привязать её к текущему пользователю)
        [HttpPost("create")]
        ...
        // Отметить/снять отметку с привычки
        ...
        // Удалить привычку пользователя (из текущих привычек)
